...
export const fixture: MetodologiaSectionProps = {
  ...
  scopeDistinction: {
    researcher: {
      title: 'Coordenação Científica — [ICT EXECUTORA]',
      subtitle: 'Direção Técnico-Científica e Fiscalização das Entregas',
      responsibilities: [
        'Define objetivos científicos e aprova especificações técnicas do projeto',
        'Fiscaliza e aceita as entregas da THATPIX contra critérios verificáveis (AgroEval, benchmarks, marcos contratuais)',
        'Lidera publicações científicas e assina como autor responsável pela ICT',
        'Assina relatórios técnicos e presta contas à FINEP',
        'Titularidade dos ativos (corpus AgroLinguaBR, modelo fine-tuned, código-fonte) permanece na ICT',
      ],
      badge: 'Proponente Científica e Fiscal dos Recursos FNDCT',
    },
    company: {
      title: 'THATPIX LTDA · Charles Cleivin, Responsável Técnico',
      subtitle: 'Entregáveis Técnicos do Fornecedor Contratado',
      responsibilities: [
        'Propõe e entrega arquitetura dos sistemas de IA conforme requisitos aprovados pela ICT',
        'Executa pipeline de fine-tuning (LoRA/PEFT, 4-bit NF4) e entrega modelo validado pelo AgroEval',
        'Desenvolve AgroAssistente (backend WhatsApp + integrações) e Coopera Digital (frontend + backend)',
        'Propõe e documenta protocolos de avaliação e benchmarks (AgroEval) para aprovação da ICT',
        'Engenharia da AgroAPI (REST, autenticação, rate-limiting, documentação) e suporte técnico 36 meses',
      ],
      note: 'Regras de Coautoria e Restrições',
      noteItems: [
        'Decisão científica e fiscal é exclusiva da ICT — THATPIX entrega, ICT avalia e aprova',
        'Coautoria de Charles Cleivin em publicações: admitida quando houver contribuição intelectual real (critérios ICMJE/Vancouver) — obrigatória declaração de vínculo comercial THATPIX na seção de conflito de interesse de cada artigo; não decorre de cargo na equipe executora',
      ],
    },
  },
  sovereigntyCallouts: [
