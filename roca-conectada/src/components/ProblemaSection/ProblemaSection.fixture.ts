...
export const fixture: ProblemaSectionProps = {
  ...
  stats: [
    ...
    { value: 'R$18,8bi', label: 'por ano em renda rural não realizada — custo documentado da ausência de ATER (RESR 2020, PSM)', colorVariant: 'red' },
  ...
  aiRaceChart: {
    ...
    entries: [
      ...
      { flag: '🇧🇷', country: 'Brasil', product: 'AgroAssistente — Roça Conectada', launched: 'mês 18 (proposto)', scale: '25.000 pares pt-BR • 3 regiões-piloto • open-source MIT', status: 'proposed' },
    ],
