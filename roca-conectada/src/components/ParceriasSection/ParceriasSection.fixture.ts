...
export const fixture: ParceriasSectionProps = {
  ...
  partners: [
    {
      ...
      name: '3 Cooperativas Âncora (CE · BA · PB)',
  ...
  actionTimeline: [
    { label: 'Semana 1 (19-23/05)', description: 'Contato inicial com cooperativas âncora nos 3 estados e com EMATER-CE, EMATER-BA, EMATER-PB. Envio de carta de apresentação do projeto.' },
