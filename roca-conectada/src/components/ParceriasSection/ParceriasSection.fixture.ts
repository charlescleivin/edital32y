...
export const fixture: ParceriasSectionProps = {
  ...
  disseminationRoutes: [
    ...
    },
    {
      ...
      mechanism: 'AgroLinguaBR publicado com DOI Zenodo (licença MIT/Apache 2.0); AgroEval publicado com código-fonte (GitHub UFSC); 5 artigos em periódicos indexados',
